 ...
 */
function kids_education_sanitize_select( $input, $setting ) {
 ...
 */
function kids_education_sanitize_image( $image, $setting ) {
	/*
 ...
 *                    the setting default.
 */
function kids_education_sanitize_number_range( $number, $setting ) {
...
* @since Kids Education 0.1
*/
function kids_education_sanitize_page( $input ) {
 ...
 */
function kids_education_sanitize_checkbox( $checked ) {
 ...
 * @since Kids Education 0.1
 */
function kids_education_sanitize_category_list( $input ) {
	if ( $input != '' ) {
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
 ...
 */
function kids_education_sanitize_google_map_iframe( $input, $setting ) {
	$allowedtags = array(
        'iframe' => array(
            'src' => array(),
            'width' => array(),
